...
heads_1 = ['ID билета', 'Аэропорт вылета', 'Аэропорт прибытия', 'Дата вылета',
           'Дата прибытия', 'Номер рейса']
heads_2 = ['Имя клиента', 'Номер рейса', 'Аэропорт вылета', 'Аэропорт прибытия',
           'Дата вылета', 'Дата прибытия']
